      ...
      <ScrollView style={{flexGrow: 1,
        ...
        source={require('../assets/sb.png')}
         >
            ...
            <Text style={{fontSize:20,paddingHorizontal:10,alignSelf:'center'}}>If you've got a nice cozy place where people can meet , network and enjoy a speaker or take a workshop in great event , connect with us for a partnership. </Text>
