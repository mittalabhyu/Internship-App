...
export function communityscreenadd(){
    ...
    style={{justifyContent:'center'}}
     ...
     />
     <CardContent text={"@"+global.draweruname}/>
    <CardContent text={"Email : "+global.dataa["response"]["email"]}/>
     <CardContent text={"City : "+global.dataa["response"]["city"]}/>
     <CardContent text= {"Country : "+global.dataa["response"]["country"]}/>
     <CardContent text= {"Contact : "+global.dataa["response"]["contact"]}/>
     ...
     renderItem={items=>(
      ...
      <TouchableOpacity
        onPress={() =>{}}
        style={{ backgroundColor: "orange",borderRadius:25,width:120, height:40,marginHorizontal:20,justifyContent:'center',fontWeight:'bold' }}>
