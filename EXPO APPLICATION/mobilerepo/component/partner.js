      ...
      <ScrollView style={{flexGrow: 1,
        ...
        source={require('../assets/pb.png')}
         >
            ...
            <Text style={{fontSize:20,alignSelf:'center'}}>We don't just do our own events only but we also collaborate with other event organizers as partners . </Text>
            <Text style={{fontSize:20,alignSelf:'center'}}>If you would like to have us as your event partner or would like to become a partner for any of our events , then fill this form right here.</Text>
