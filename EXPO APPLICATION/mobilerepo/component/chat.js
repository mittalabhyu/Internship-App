 ...
 export function Login({navigation,route}){
   ...
   const {name}=route.params;
    ...
    useEffect(() => {
      setMessages([
        {
          _id: 1,
          text: "Start your journey with a new message",
          createdAt: new Date(),
          user: {
            _id: 2,
            name: 'React Native',
   ...
   {/* return(
      <View style={styles.container}>
         ...
         <TextInput
         style={{alignSelf:'center',height:50,margin:10,padding:5,paddingLeft:20, backgroundColor:'lightgray',width:'90%',borderRadius:20,fontSize:20}}
         placeholder='Whats your interesting idea today?'
         placeholderTextColor='darkgrey'
         />
         <View style={{flex:1}}>
        <Text style={{color:'red',fontSize:30,paddingHorizontal:10}}>Chat Feature will be avaliable soon</Text>
        </View>
