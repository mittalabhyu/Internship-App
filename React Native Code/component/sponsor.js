        ...
        <ScrollView style={{
            ...
            <View style={{ alignItems: 'center', flex: 1 }}>
                <View style={{ justifyContent: 'center' }}><ImageBackground style={{ width: 300, height: 300 }}
                    source={require('../android/app/src/main/assets/spb.png')}
                >
                    <Text style={{ fontSize: 30, fontWeight: 'bold', alignSelf: 'center', marginVertical: 5 }}>Sponsor Us</Text>
                    <Text style={{ fontSize: 20, textAlign:'center' }}>We have many interest based communities of engaged members . </Text>
                    <Text style={{ fontSize: 20, textAlign:'center' }}>If you would like to spread your message or brand among these communities , then connect with us to help in setting up  a geat event together .</Text>
